...
- id: wta2457b5d
  ...
  description: '**ALL GAP ANALYSES COMPLETE** ✅
    ...
    All 9 old terms documents have been analysed and placement decisions made.
    ...
    **COMPLETED ANALYSES:**
    ...
    ✅ Sale of Goods → **RETIRED** — MSA cl 4-8 already covers goods; see Task 0.1
    Decision R1

    ✅ Business Communications → **Annex 3E** — keep almost all intact; see Task 0.1
    Decision S4

    ✅ Mobile Terms → **Annex 3G** — keep almost all intact; see Task 0.1 Decision
    S5


    **OLD TERMS HIERARCHY (FINDING):**
    ...
    **RESULTING ANNEX STRUCTURE:**

    • Annex 3D: Connectivity (from Ethernet terms)

    • Annex 3E: Telecoms (from Business Comms + Horizon additions)

    • Annex 3G: Mobile Services (from Mobile terms — separate from 3E)

    • Schedule 5: Maintenance (from HJ1 + old maintenance terms)
...
✅ Access Control Maintenance → Task 1.6 (Schedule 5 enhancements)
✅ CCTV Maintenance → Task 1.6 (Schedule 5 enhancements)
✅ Sale of Goods → **RETIRED** — MSA cl 4-8 already covers goods; see Task 0.1 Decision R1
✅ Business Communications → **Annex 3E** — keep almost all intact; see Task 0.1 Decision S4
✅ Mobile Terms → **Annex 3G** — keep almost all intact; see Task 0.1 Decision S5
